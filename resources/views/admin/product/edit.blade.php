                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="sale_price" name="sale_price" value="{{ old('sale_price', $product->sale_price) }}" min="0" step="0.01">
                                <small class="text-muted">Phải nhỏ hơn hoặc bằng Giá. Để trống nếu không có.</small>
                            </div>
                        </div>
                    </div>
